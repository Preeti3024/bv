                ...
                children: <Widget>[
                  AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? child) {
                      // Add the '?' for optional child argument
                      return Container(
                        height: 100,
                        width: 100,
                        ...
                        child: ScaleTransition(
                          // Apply ScaleTransition directly to the child
                            ...
                            child: CircleAvatar(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                  // Use const for immutable TextStyle
                                  fontSize: 50.0,
                    ...
                    builder: (BuildContext context, Widget? child) {
                      ...
                      return Padding(
                        padding: const EdgeInsets.only(
                            top: 8, bottom: 8), // Use 'const' for immutability
                        child: Transform.translate(
                          // Use Transform.translate for convenience
                          offset: Offset(
