...
class _VoiceRegistrationDialogState extends State<VoiceRegistrationDialog> {
  ...
  _stopRecording(i) async {
    if (_recorder != null) {
      ...
      RecordingStatus status = (await _recorder!.current(channel: 0))
          as RecordingStatus; // Get status for channel 0
      bool isRecording =
          status == RecordingStatus.Recording; // Check if recording
      ...
      setState(() {
        ...
        _recorder = null; // Reset the recorder
      });
    }
  }
