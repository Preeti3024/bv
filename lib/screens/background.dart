...
class Background extends StatelessWidget {
  ...
  Background({Key? key, required this.title, this.isImage}) : super(key: key);
      ...
      body: Column(
        children: <Widget>[
          new Stack(
            ...
            children: <Widget>[
              isImage == true
                  ? Image.asset('assets/images/logo_long.png',
...
class YellowCircleClipper extends CustomClipper<Rect> {
  ...
  Rect getClip(Size size) {
    // Calculate the appropriate Rect using size
    return Rect.fromLTWH(0, 0, size.width, size.height); // Example
  }
